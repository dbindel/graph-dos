function  [A,rows,cols,entries,rep,field,symm] = load_market(filename)
%
% function  [A] = load_market(filename)
%
% function  [A,rows,cols,entries,rep,field,symm] = load_market(filename)
%
...
% Source: http://math.nist.gov/MatrixMarket/mmio/matlab/mmiomatlab.html
