...
smatfile=fullfile(path,'data',[graphname '.smat']);
smatgzfile=fullfile(path,'data',[graphname '.smat.gz']);
...
if nargout > 1
    varargout{1} = load(fullfile(path,'data',[graphname '.smat.normalized.eigs']));
end